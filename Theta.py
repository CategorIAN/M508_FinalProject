...
class Theta:
    def __init__(self, theta_1, theta_2, theta_3, theta_4, theta_5a, theta_5b, theta_6, theta_7):
        self.p = theta_1.shape[0]
        self.theta_1 = theta_1
        self.theta_2 = theta_2
        self.theta_3 = theta_3
        self.theta_4 = theta_4
        self.theta_5a = theta_5a
...
class RandomTheta (Theta):
    def __init__(self, p):
        ...
        super().__init__(theta_1, theta_2, theta_3, theta_4, theta_5a, theta_5b, theta_6, theta_7)